...
public class WhatsappSender {
    ...
    private static final String WA_GATEWAY_URL = "http://api.whatsmate.net/v2/whatsapp/single/message/" + INSTANCE_ID;

    /**
     * Entry Point
     */
    public static void main(String[] args) throws Exception {
        String number = "918050702278";  //  TODO: Specify the recipient's number here. NOT the gateway number
